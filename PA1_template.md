...
## [1] 10765
```
The mean of total number of steps taken per day is 1.0766189\times 10^{4}. The meadian of total number of steps taken per day is 10765
...
```
On Average across all days in the dataset, the 835 5-min interval contains the maximum number of steps.
